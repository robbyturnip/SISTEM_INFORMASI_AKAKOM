...
public class Info extends Fragment {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.info, parent, false));
            gambar = (ImageView) itemView.findViewById(R.id.gambarInfo);
            judul = (TextView) itemView.findViewById(R.id.judulinfo);
            penjelasan = (TextView) itemView.findViewById(R.id.penjelasan);
            gambarAdmin = (ImageView) itemView.findViewById(R.id.gambarAdmin);
            tanggal = (TextView) itemView.findViewById(R.id.tanggalinfo);
            penulis = (TextView) itemView.findViewById(R.id.penulisinfo);
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Context context = v.getContext();
                    Intent intent = new Intent(context, RincianInfo.class);
                    intent.putExtra(RincianInfo.EXTRA_POSITION, getAdapterPosition());
            ...
            ImageButton favoriteImageButton =
                    (ImageButton) itemView.findViewById(R.id.baca);
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            judul = resources.getStringArray(R.array.judul_info);
            penjelasan = resources.getStringArray(R.array.diskripsi_awal_info);
            penulis= resources.getStringArray(R.array.penulis);
            tanggal = resources.getStringArray(R.array.tanggal_info);
            ...
            b.recycle();
            TypedArray a = resources.obtainTypedArray(R.array.gambar_info);
